...
class Cricketscoreboard2team
{
	public static void main(String args[])
	{
		...
		byte oc=0,byr=0,runout=0,change=0;
			...
			{	
				...
				oc=0;
					...
					if(run==9)
					{
						...
						System.out.println("------------------");
						System.out.println("BY-RUNs....enter extra run:");
						lgbrn=scr.nextInt();
						System.out.println("------------------");
		...
		System.out.println("\n--------------------------------------------------------------------------------------------------------");
					...
					System.out.println(" Total by-run is = "+tbyrn);
		...
		System.out.println("ENTER   9   IN CASE OF LEG-BY-RUN!!!");
		System.out.println("ENTER   10  IN CASE OF NO-BALL & RUN FROM BATSMAN!!!");
		System.out.println("ENTER   11  IN CASE OF NO-BALL & BY-RUN!!!");
		System.out.println("ENTER   12  IN CASE OF BY-RUN!!!");
		System.out.println("ENTER   13  IN CASE OF RUN-OUT!!!");
